...
#ifndef RTW_HEADER_AbstractFuelControl_expanded_breach_acc_private_h_
#define RTW_HEADER_AbstractFuelControl_expanded_breach_acc_private_h_
#include "rtwtypes.h"
...
; real_T AbstractFuelControl_expanded_breach_acc_rt_VTDelayfindtDInterpolate
...
initOutput , real_T * appliedDelay ) ; extern real_T look2_binlxpw ( real_T
u0 , real_T u1 , const real_T bp0 [ ] , const real_T bp1 [ ] , const real_T
table [ ] , const uint32_T maxIndex [ ] , uint32_T stride ) ;
#endif
